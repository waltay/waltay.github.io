const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=2ddcd5a3794e5fbc35968fc620259c8c';
const apiForecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=2ddcd5a3794e5fbc35968fc620259c8c';
...
.then((jsObject) => {
    ...
    for(i = 0; i < townInfo.length; i++){
        ...
        if(townInfo[i].name == 'Soda Springs'){
